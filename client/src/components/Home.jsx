...
const Home = () => {
  ...
  const Input = (placeholder, name, type, value, handleChange) => (
    <Input
      ...
      step="0.0001"
      value={value}
      onChnge={(e)=> handleChange(e, name)}
      className="my-2 w-full rounded-sm p-2 outline-none bg-transparent text-white border-none text-sm white-glassmorphism"
    />
  );
  return (
    <div className='flex w-full justify-center items-center'>
      <div className='flex mf:flex-row flex-col items-start justify-between :p-20 py-12 px-4'>
        <div className='flex flex-1 justify-start flex-col mf:mr-10'>
          <h1 className='text-3xl :text-5xl text-white text-gradient py-1'>
            Send Crypto <br /> accross the world
          </h1>
          <p className='text-left mt-5 text-white font-light :w-9/12 w-11/12 text-base'>
          ...
          <div className='grid grid-col-2 :grid-col-3 w-full mt-10'>
        ...
        <div className='flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10'>
          ...
          <div className='p-5 dm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism'>
            ...
            {/* self closing div for line under input field */}
